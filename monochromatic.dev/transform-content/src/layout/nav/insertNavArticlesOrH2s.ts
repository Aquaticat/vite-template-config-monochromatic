const insertNavArticlesOrH2s = (document: Document) => {
  ...
  if (
    document.body.querySelectorAll(':scope > wrapper-block > main > article').length >= 2) {
...
`).join('')}
    ...
    `;
  } else if (document.body.querySelectorAll(':scope > wrapper-block > main > article > wrapper-block > section > h2').length
             >= 2) {
    navDetailsWrapperBlock.innerHTML = `
${navDetailsWrapperBlock.innerHTML}
...
<ol>
${[...document.body.querySelectorAll(':scope > wrapper-block > main > article > wrapper-block > section:has(> h2)')].map(
                                                                                                                                                                                                 (
                                                                                                                                                                                                   h2Section,
                                                                                                                                                                                                 ) => `
<li>
