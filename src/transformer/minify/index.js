...
const minify = (file, format = 'html') => {
  ...
  switch (format) {
    case 'html': {
      ...
      shell.exec(`echo 'yes' && pnpm exec html-minifier-terser --case-sensitive --collapse-whitespace --conservative-collapse --decode-entities --keep-closing-slash --preserve-line-breaks -o '${tempFilePath.out}' '${tempFilePath}'`,
                 () => {
                 });
